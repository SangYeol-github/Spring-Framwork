...
<body>
	...
	<main>
		...
		<c:forEach var="u" items="${list}">
			...
			<a href="/jdbc/detail?userid=${u.uid}" >${u.name}</a>
			</label><label>${u.phone}</label></div>
		</c:forEach>
	</main>
	<p>
	[<a href = "/jdbc/add">사용자정보 추가</a>]   <!-- get방식 -->
	<button type="button" 
		onclick="location.href='/jdbc/add';">사용자정보 추가</button>
	<button type="button" 
		onclick="location.href='/jdbc/logout';">로그아웃</button>
</body>
</html>